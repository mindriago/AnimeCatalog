...
public class AnimeService {
    ...
    // --- NEW METHOD ADDED FOR FR4 (Recommendations) ---
    // This allows the Service to delegate the recommendation logic to the Strategy object
    public List<Anime> getRecommendations(RecommendationStrategy strategy) {
        // Convert Map values to List because the Strategy expects a List
        List<Anime> allAnimes = new ArrayList<>(animeRepository.values());
        return strategy.getRecommendations(allAnimes);
    }
    // --------------------------------------------------
